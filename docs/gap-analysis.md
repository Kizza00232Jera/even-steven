...
### ~~Remaining UI/UX Gaps~~ — Partially done 2026-05-22

| # | Gap | Spec ref | Status |
|---|-----|----------|--------|
| ~~12a~~ | ~~Member Profile Sheet (tap avatar → balance + Settle Up + Add Friend)~~ | §16 | ✅ Done 2026-05-22 |
| ~~12b~~ | ~~Group-level display name (tap own row in Members → set per-group name)~~ | §6 | ✅ Done 2026-05-22 |
| ~~12c~~ | ~~Post-sign-in invite context (store token before auth, re-apply after)~~ | §9 | ✅ Done 2026-05-22 |
| ~~12d~~ | ~~Auto-archive group when all balances reach zero~~ | §22 | ✅ Done 2026-05-22 |
| ~~12e~~ | ~~Trip expiry scheduled push notification (pg_cron)~~ | §17 | ✅ Done 2026-05-22 |
| ~~12f~~ | ~~Group settings: Change group photo wired to upload~~ | §7 | ✅ Done 2026-05-22 (was already wired) |
| ~~12g~~ | ~~Date picker in edit-expense form (date is immutable post-create per spec)~~ | §11 | N/A |
